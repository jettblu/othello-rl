...
export class OthelloAgent {
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        OthelloAgentFinalization.unregister(this);
        return ptr;
    }
    free() {
    ...
    constructor() {
        ...
        OthelloAgentFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
}
if (Symbol.dispose) OthelloAgent.prototype[Symbol.dispose] = OthelloAgent.prototype.free;
...
const OthelloAgentFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_othelloagent_free(ptr, 1));
